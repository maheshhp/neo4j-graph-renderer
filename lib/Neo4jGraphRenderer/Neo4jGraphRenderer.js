...
var _renderResult = require('./assets/render-result');

var _transformResult = require('./assets/transform-result');
...
exports.default = {
  renderResult: _renderResult.renderResult,
  Neo4JGraphRenderer: Neo4JGraphRenderer,
  transformResult: _transformResult.transformResult
};